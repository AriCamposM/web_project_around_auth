  ...
  function handleFooterText () {
    ...
    return(
        ...
        <div className="register__container-header">
          ...
          />
          <p className="register__login" onClick={handleFooterText}>Iniciar sesión</p>
        </div>
        </header>
        <div className="register__container">
            <form className="register__form" onSubmit={handleSubmit}>
                ...
                <input className="register__input-email" 
                id="email" 
                ...
                <input className="register__input-password" 
                id="password" 
                ...
                <p className="register__footer">¿Ya eres miembro? <span onClick={handleFooterText}>Inicia sesión aquí</span></p>
