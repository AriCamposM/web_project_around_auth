...
function Login ({handleLogIn, setCurrentEmail}) {
  ...
  return(
        ...
        <div className="login__container-header">
          ...
          />
          <p className="login__register" onClick={handleFooterText}>Regístrate</p>
        </div>
        </header>
        <div className="login__container">
            <form className="login__form" onSubmit={handleSubmit}>
                ...
                <input className="login__input-email" 
                id="email" 
                ...
                <p className="login__footer">¿Aún no eres miembro? <span onClick={handleFooterText}>Regístrate aquí</span></p>
